...
/*   Updated: 2023/02/20 18:08:20 by tde-melo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	is_philo_full(t_philo *philo)
{
	...
	if (philo->dinner_info->nbr_of_meals
		&& (++philo->meals_count == philo->dinner_info->nbr_of_meals))
	{
		if (++philo->dinner_info->nbr_of_philos_full == \
philo->dinner_info->nbr_of_philos)
		{
